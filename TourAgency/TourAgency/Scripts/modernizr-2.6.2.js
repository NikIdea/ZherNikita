...
window.Modernizr = (function( window, document, undefined ) {
    ...
    tests['opacity'] = function() {
        ...
        // github.com/Modernizr/Modernizr/issues/#issue/59/review/516632
    ...
    // However read the reviews to dig into applying SVG clippaths to HTML content here:
    //   github.com/Modernizr/Modernizr/issues/213#issuereview-1149491
    ...
    /*jshint evil:true */
      ...
      function shivDocument(ownerDocument) {
        ...
        if (html5.shivCSS && !supportsHtml5Styles && !data.hasCSS) {
          data.hasCSS = !!addStyleSheet(ownerDocument,
            ...
            'Tour,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}' +
      ...
      var html5 = {
         ...
         * @type Array|String
         */
        'elements': options.elements || 'abbr Tour aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video',
